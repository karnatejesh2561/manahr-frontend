...
import { ConfirmDialog, Drawer, FilterChip, FilterPanel, RowMenu, SearchInput, useToast } from '@/components/demos/Interactions';
...
export default function CRMWrapper() {
    ...
    return (
        ...
        >
            ...
            {/* Pipeline kanban */}
            <motion.div className="sc-card mb-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-6">
                ...
                <motion.div className="sc-card p-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.45 }}>
                    ...
                    <DonutChart size={150} thickness={15}
            ...
            {/* Deals table */}
            <motion.div className="sc-card overflow-auto p-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
