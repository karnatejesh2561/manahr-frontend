...
import { BarChart, AnimatedNumber } from '@/components/demos/Charts';
import { FilterPanel, FilterChip, SearchInput, useToast } from '@/components/demos/Interactions';
                ...
                <div className="space-y-2">
                    {filtered.map((e, i) => (
                        <motion.div key={i} className="grid grid-cols-[80px,180px,1fr,auto] gap-4 p-3 rounded-xl items-center"
                            style={{ background: 'rgba(0,0,0,0.02)', border: '1px solid var(--sc-border)' }}
