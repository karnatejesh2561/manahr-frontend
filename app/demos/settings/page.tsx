...
<<<<<<< HEAD:app/showcase/settings/page.tsx
...
>>>>>>> 42fd257aafd27a120ccb1129f1b62a7137460387:app/demos/settings/page.tsx
          ...
          {sections.map(s => {
            ...
            return (
              <button key={s.id} onClick={() => setActive(s.id)}
                className={`sc-sidebar-link w-full ${active === s.id ? 'active' : ''}`}
