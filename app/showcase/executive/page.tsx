...
export default function ExecutivePage() {
  ...
  return (
    ...
    >
      {/* AI banner */}
      <motion.div className="sc-card p-5 mb-6 flex items-start gap-4" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-6">
        <motion.div className="sc-card p-6 xl:col-span-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
          ...
          <MultiLineChart height={260} labels={['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']} series={[
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-6">
        ...
        <motion.div className="sc-card p-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.55 }}>
          ...
          <BarChart height={200} labels={['APAC','NA','EU','LATAM','MEA']} data={[342, 528, 412, 188, 96]} color="#6affe0" />
        ...
        <motion.div className="sc-card p-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }}>
          ...
          <div className="space-y-3">
            {[
              ...
              { t: 'Invoice overdue', d: 'INV-2841 — $4,200 · 7 days late', tm: '2h ago', c: '#ffb547' },
            ].map((a, i) => (
