                            ...
                            <div className="glass rounded-3xl p-8 h-full border border-white/20 hover:border-[#0e67ff]/40 transition-all duration-300 hover:shadow-xl">
                                ...
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    <motion.div
                                        ...
                                        className={`w-10 h-10 relative overflow-hidden rounded-full bg-[#FD4F0F] flex items-center justify-center`}
                                    >
                                    ...
                                    <div className="space-y-2">
                                        {study.results.map((result, idx) => (
                                            <div key={idx} className="flex items-start gap-2">
                                                <CheckCircle2 size={18} className="text-[#FD4F0F] mt-0.5 flex-shrink-0" />
                ...
                >
                    <Link href="/case-studies">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.97 }}
                            className="relative px-8 py-4 bg-[#0e67ff] text-white font-semibold rounded-full shadow-[0_18px_40px_rgba(14,103,255,0.18)] transition-all duration-300"
                        >
                            <span className="absolute block inset-x-0 top-0 h-1/2 bg-gradient-to-b from-white/25 to-transparent rounded-full z-2" />
                            Start Your Project
                        </motion.button>
