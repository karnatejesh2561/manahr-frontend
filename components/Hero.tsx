    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <Link href="/case-studies">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="px-8 py-4 glass border-2 border-black text-black font-semibold rounded-full transition-all duration-300"
                        >
                            View Our Work
                        </motion.button>
                    </Link>
            ...
            >
                ...
                >
                    <ChevronDown size={32} className="text-[#0e67ff]" />
                </motion.div>
            </motion.div>
        </section>
    );
